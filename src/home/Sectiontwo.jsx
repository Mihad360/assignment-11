        ...
        <div className="dark:bg-black dark:text-white">
            <div className="py-8 ">
                ...
                <div className="image text-white py-40 flex flex-col lg:flex-row justify-center items-center gap-6 dark:bg-black dark:text-white">
                    <div className="card card-side shadow-xl flex-col md:flex-row md:p-10  bg-white w-64 md:w-[600px] dark:bg-black dark:text-white">
                    ...
                    <div className="card card-side bg-base-100 shadow-xl flex-col md:flex-row md:p-10 w-64 md:w-[600px] dark:bg-black dark:text-white">
